class AllQualificationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @qualification.save
        format.html { redirect_to all_qualification_path(@qualification), notice: 'Qualification was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @qualification.update(qualification_params)
        format.html { redirect_to all_qualification_path(@qualification), notice: 'Qualification was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to all_qualifications_url, notice: 'Qualification was successfully destroyed.' }
