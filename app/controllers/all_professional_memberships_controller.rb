class AllProfessionalMembershipsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @professional_membership.save
        format.html { redirect_to all_professional_membership_path(@professional_membership), notice: 'Professional membership was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to al_professional_memberships_url, notice: 'Professional membership was successfully destroyed.' }
